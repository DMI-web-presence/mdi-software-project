    ...
    <main className="min-h-screen bg-[#fbfaf8]">
      <header className="relative z-30 border-b border-[#e6e3df] bg-white">
        <div className="mx-auto grid min-h-[76px] w-[min(1360px,calc(100%-48px))] grid-cols-[1fr_auto_1fr] items-center max-[1023px]:w-[min(100%-32px,900px)] max-[820px]:min-h-[68px] max-[820px]:grid-cols-[1fr_auto] max-[520px]:w-[calc(100%-24px)]">
          <Link className="focus-ring" href="/" aria-label="MDI Software - pagina principală">
            <Image
          ...
          <Link className="inline-flex min-h-[42px] items-center gap-2 justify-self-end rounded-[5px] bg-[#111419] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#253143] max-[520px]:min-h-[38px] max-[520px]:px-3 max-[520px]:py-2" href="#brief-form">
            Începe
